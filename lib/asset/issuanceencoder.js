...
IssuanceEncoder.prototype.encode = function(byteSize) {
  ...
  $.checkState(this.divisibility, 'divisibility must be set');
  ...
  var protocolBuf = new Buffer(this.padLeadingZeros(this.protocol.toString(16), 2), 'hex');
  ...
  var issueTail = Buffer.concat([this.amount, payments, issueFlagsByte]);
